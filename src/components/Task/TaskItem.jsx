    ...
    return (
        props.newTask ?
            <div className='taskItem'>
                ...
                <div className='itemBody'>
                    ...
                    <div className={`detailContainer ${toogleDetail && 'show'}`}>
                        ...
                        <div className='desc'>
                            <div className={`icon iconGrey`} onClick={editDescHandler}></div>
                            {
                                editDesc ?
                                    <textarea className='inputDesc'></textarea> :
            ...
            <div className='taskItem' key={props.id}>
                <div className='itemCheckbox'>
                    <input type="checkbox" checked={taskDone} className='checkbox' onClick={taskDoneHandler} />
                </div>
                <div className='itemBody'>
                    <div className='titleContainer'>
                        {
                    ...
                    <div className={`detailContainer ${toogleDetail && 'show'}`}>
                        ...
                        <div className='desc'>
                            <div className={`icon ${!props.data.description && 'iconGrey'}`} onClick={editDescHandler}></div>
                            {
                                editDesc ?
                                    <textarea className='inputDesc'>{props.data.description || ''}</textarea> :
                                    <p className='descText' onClick={editDescHandler}>{props.data.description || 'No description'}</p>
                            }
                        </div>
                    </div>
                </div>
